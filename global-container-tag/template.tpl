...

{
  ...
  "version": 1,
  "securityGroups": [],
  "displayName": "Pepperjam Global Container Tag",
  "brand": {
    "id": "brand_dummy",
    "displayName": "",
  ...
  "description": "A container tag needs to be placed on every page on the site.",
  "containerContexts": [
    "WEB"
  ]
}
...
[
  {
    ...
    "help": "Unique ID each advertiser and is required for the tag to work.",
    "valueValidators": [
      {
        "type": "NON_EMPTY"
      }
...
Created on 2/18/2020, 1:55:28 PM
